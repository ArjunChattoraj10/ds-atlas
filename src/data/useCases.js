  ...
  },
  {
    ...
    useCases: [
      ...
      },
      {
        ...
        description: "Understand why shoppers fill their carts but don't buy — and intervene at the right moment with the right nudge (free shipping, a reminder email, a simpler form).",
        examples: [
          "An e-commerce site triggers a 10 %-off popup when it predicts a high-value cart is about to be abandoned.",
          "A subscription service sends an email within 30 minutes of cart abandonment with a one-click checkout link.",
        ],
        poweredBy: "Propensity models predict abandonment risk in real time; experimentation determines the best intervention. The system watches each shopper's behavior during checkout and estimates the chance they'll leave without buying. If the risk is high, it can trigger a targeted action — like a discount pop-up or simplified form — that's been proven through testing to recover the sale.",
        relatedMethods: [
          { methodId: "gbm-clf", topicId: "classification", name: "Gradient Boosting (Classifier)" },
          { methodId: "logistic", topicId: "classification", name: "Logistic Regression" },
          { methodId: "ab", topicId: "causal", name: "A/B Testing" },
